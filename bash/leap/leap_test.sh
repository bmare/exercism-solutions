#!/usr/bin/env bash
# outputs true if divisble 4, but not by 100. And if divisible by 400.
# no input should return error
# too many arguments should return an error
# float number should return an error 
# alphabetic input should return an error
